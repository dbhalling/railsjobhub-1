namespace :jsstack do
  task js: :environment do
    require 'open-uri'
    require 'nokogiri'

    url = 'https://stackoverflow.com/jobs/feed?tl=javascript'
    open(url) do |rss|
    ...
    Jsstackjob.where("created_at < ?", (Time.now - 10.minutes)).destroy_all
  end  #end task
end  #end namespace
