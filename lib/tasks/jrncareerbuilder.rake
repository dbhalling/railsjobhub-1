namespace :rncareerbuilder do
  task rn: :environment do
    require 'mechanize'

    a = Mechanize.new
    a.user_agent_alias = 'Mac Safari 4'
    page = a.get('http://www.careerbuilder.com/jobs-%2522react-native%2522?sort=date_desc')
    ...
    Rncareerbuilder.where("created_at < ?", (Time.now - 10.minutes)).destroy_all
  end
end
