namespace :jscareerbuilder do
  task js: :environment do
    require 'mechanize'

    a = Mechanize.new
    a.user_agent_alias = 'Mac Safari 4'
    page = a.get('http://www.careerbuilder.com/jobs-javascript?sort=date_desc')
    ...
    Jscareerbuilder.where("created_at < ?", (Time.now - 10.minutes)).destroy_all
  end
end
